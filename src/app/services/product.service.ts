...
export class ProductService {
  ...
  private searchUrl = environment.shopApiUrl + '/products';
  ...
  getProducts(searchUrl: string): Observable<Product[]> {
    return this.httpClient.get
      <ApiResponseProduct>(searchUrl)
      .pipe(
        tap(response => console.log('getProducts Response:', response)),
  ...
  getProductListPaginate(
    ...
    return this.httpClient.get<ApiResponseProduct>(searchUrl)
      .pipe(
        tap(response => console.log('getProductListPaginate Response:', response)),
  ...
  getProductCategories(): Observable<ProductCategory[]> {
    return this.httpClient.get<ResponseProductCategory>(this.categoryUrl)
      .pipe(
        tap(response => console.log('getProductCategories Response:', response)),
        map(response => response.content));
  ...
  searchProducts(theKeyword: string | null): Observable<Product[]> {
    ...
    console.log("Search Products Fuction calling...");
